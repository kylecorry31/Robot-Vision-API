...
class TargetGroupScorer {
     ...
     */
    static double widthRatioScore(TargetGroup target, double idealRatio) {
     ...
     * @return A score from 0 to 100.
     */
    static double heightRatioScore(TargetGroup target, double idealRatio) {
     ...
     * @return a score from 0 to 100.
     */
    static double topAlignmentScore(TargetGroup target) {
     ...
     * @return a score from 0 to 100.
     */
    static double leftAlignmentScore(TargetGroup target) {
     ...
     * @return A score from 0 to 100.
     */
    static double targetWidthToGroupWidthScore(TargetGroup target, double idealRatio) {
     ...
     * @return A score from 0 to 100.
     */
    static double targetHeightToGroupHeightScore(TargetGroup target, double idealRatio) {
