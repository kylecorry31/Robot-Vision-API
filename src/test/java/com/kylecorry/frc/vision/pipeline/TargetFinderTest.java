...
public class TargetFinderTest {
    ...
    public void setUp() throws Exception {
        ...
        CameraSettings cameraSettings = new CameraSettings(false, 2, new ViewAngle(60, 60), new Resolution(640, 480));
    ...
    public void findTargets() {
        ...
        List<TargetOutput> targets = targetFinder.findTargets(image);
